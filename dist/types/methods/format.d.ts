 ...
 */
export declare const formatToPartsSync: (time: number | Date, localOrOptions?: locale | formatOptions, styleOrOptions?: style | formatOptions) => formatParts;
export declare const formatSync: (time: number | Date, localOrOptions?: locale | formatOptions, styleOrOptions?: style | formatOptions) => string;
export declare const formatToParts: (time: number | Date, localOrOptions?: locale | formatOptions, styleOrOptions?: style | formatOptions) => Promise<formatParts>;
export declare const format: (time: number | Date, localOrOptions?: locale | formatOptions, styleOrOptions?: style | formatOptions) => Promise<string>;
